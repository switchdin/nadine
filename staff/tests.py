...
class MembershipTestCase(TestCase):
	...
	def testDateMethods(self):
		...
		m2 = Membership.objects.create(member=self.user2.get_profile(), membership_plan=self.residentPlan, start_date=date(2012, 6, 15))
		...
		m3 = Membership.objects.create(member=self.user3.get_profile(), membership_plan=self.residentPlan, start_date=date(2012, 6, 16))
		...
		m4 = Membership.objects.create(member=self.user4.get_profile(), membership_plan=self.residentPlan, start_date=date(2012, 3, 31))
		self.assertEquals(m4.prev_billing_date(test_date), date(2013, 2, 28))
		# What about leap years?
		test_date = date(2012, 3, 15)
		m5 = Membership.objects.create(member=self.user5.get_profile(), membership_plan=self.residentPlan, start_date=date(2011, 3, 31))
